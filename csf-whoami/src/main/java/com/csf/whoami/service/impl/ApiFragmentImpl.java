...
public class ApiFragmentImpl implements ApiFragment {
    ...
    public String sidebarChannel(String groupId) {
        ...
        return templateService.exportHtmlBody(templateService.getContent("sidebar-channels", params));
    }
    ...
    public String messageConents(String channelId) {
        ...
        return templateService.exportHtmlBody(templateService.getContent("messages-content", params));
    }
}
