...
import com.csf.common.constant.ConstantDefine;
...
public class DateTimeUtils {
	 ...
	 * @return date
	 */
	public static Date stringToTime(String date, String pattern) throws Exception {
	...
	public static String convertDateToString(Date date, String pattern) {
		try {
			...
			if (ConstantDefine.YYYYMMDDThhmmssZ.equals(pattern)) {
				pattern = ConstantDefine.YYYYMMDDhhmmss;
				SimpleDateFormat dateFormat = new SimpleDateFormat(pattern);
				return dateFormat.format(date).replace(ConstantDefine.SPACE, ConstantDefine.T).concat(ConstantDefine.Z);
			} else {
				SimpleDateFormat dateFormat = new SimpleDateFormat(pattern);
	 ...
	 */
	public static long getDateNumberBetweenToDate(String fromDate, String toDate, String pattern)
			throws ParseException {
		SimpleDateFormat simpleDateFormat = new SimpleDateFormat(pattern);
		Date startDate = simpleDateFormat.parse(fromDate);
		Date endDate = simpleDateFormat.parse(toDate);

		return (endDate.getTime() - startDate.getTime()) / ConstantDefine.DAY_MILISECONDS;
	}
}
