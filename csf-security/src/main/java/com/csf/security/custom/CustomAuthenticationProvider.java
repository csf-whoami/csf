	...
	public Authentication authenticate(final Authentication authentication) throws AuthenticationException {
		...
		if (appUser != null) {
			...
			if (providedUserEmail.equalsIgnoreCase(appUser.getUserName())
					&& bCryptEncoder.matches(providedUserPassword.toString(), appUser.getUserPassword())) {
				...
				return new UsernamePasswordAuthenticationToken(appUser.getUserName(), appUser.getUserPassword(), list_authorities);
			}
		}
